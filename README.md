...
Ademas este proyecto utiliza SonarQube para analizar la calidad del código de forma continua, el análisis de calidad se ejecuta automáticamente en cada push mediante SonarQube.
